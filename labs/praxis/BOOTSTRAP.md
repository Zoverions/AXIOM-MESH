...
- signed charter verification and the trust root that pins policies, verifiers,
  principal kinds and agent/principal bindings;
...
- signed charter policy/verifier pinning;
