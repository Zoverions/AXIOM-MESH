"""
Security helpers for knowledge graph ingestion.

Copied verbatim from graphify/security.py (v0.3.1)
https://github.com/safishamsi/graphify

Provides:
- validate_url(): SSRF protection (http/https only, no private IPs)
- sanitize_label(): XSS protection (strip controls, HTML escape, 256-char cap)
- validate_graph_path(): Path traversal protection (containment check)
- safe_fetch() / safe_fetch_text(): Size-limited fetching with redirect validation

Integration: Phase 3 - Security hardening for Gateway and Sandbox ingestion paths
"""
