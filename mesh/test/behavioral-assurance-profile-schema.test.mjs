...
test('Behavioral Assurance Profile v0 schema is strict probability-calibrated and zero-authority', async () => {
  ...
  assert.ok(schema['x-axiom-semantic-rules'].some(rule => /probability/i.test(rule) && /calibration/i.test(rule) && /#1588|bounded-decision-calibration|independently sourced/i.test(rule)));
