...
test('Mind Independence Review v0 remains evidence-only and model-non-authorizing', async () => {
  ...
  assert.equal(schema.properties.developmental_state_evidence_digest.pattern, '^[a-f0-9]{64}
  ...
  assert.equal(schema.properties.continuity_evidence_digest.pattern, '^[a-f0-9]{64}
