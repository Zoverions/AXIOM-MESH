...
test('infrastructure-node plan keeps service-unit projection separate from node enrollment', () => {
...
test('unsupported host facts fail closed into explicit blockers', () => {
  const plan = buildHostInstallPlan({
