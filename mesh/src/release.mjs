...
export function verifyProductionDeployment({
  ...
  for (const boundary of [
    ...
    '41 exact caller/destination/method/route',
  ...
  for (const required of [
    ...
    'node src/lib/runtime-adapter-contract.mjs',
    'node src/runtime-adapter-conformance.mjs',
    '--require-commit-bound',
    ...
    'axiom-runtime-adapter-reference-conformance-evidence-${{ github.sha }}',
