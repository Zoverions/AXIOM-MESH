...
// Preserve the approved meanings in ADAPTIVE-ASSURANCE-AND-PLURAL-AUTHORITY.md.
export const ASSURANCE_TIERS = Object.freeze([
  Object.freeze({
    id: 'A0', rank: 0, name: 'ephemeral',
  ...
  Object.freeze({
    id: 'A1', rank: 1, name: 'attributable',
  ...
  Object.freeze({
    id: 'A3', rank: 3, name: 'independently_verified',
  ...
  Object.freeze({
    id: 'A4', rank: 4, name: 'collectively_finalized',
