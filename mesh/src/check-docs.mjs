...
export const CANONICAL_DOCUMENTS = Object.freeze([
  ...
  'AGENT-ENTRY.md',
  'docs/README.md',
  'docs/HUMAN-ENTITY-SOCIETAL-INTEGRATION-INDEX.md',
  'docs/MASTER-TODO.md',
  ...
  'docs/MASTER-TODO-HUMAN-ENTITY-SOCIETAL-FABRIC.md',
  'docs/ROADMAP.md',
  'docs/ROADMAP-EXTENSION-PLURAL-AUTHORITY.md',
  'docs/ROADMAP-EXTENSION-AGENT-INTEROPERABILITY.md',
  'docs/ROADMAP-EXTENSION-HUMAN-ENTITY-SOCIETAL-FABRIC.md',
  ...
  'docs/architecture/BLANK-EGG-OPEN-ENTITY-FOUNDATION.md',
  'docs/architecture/DIGITAL-ENTITY-STATUS-AND-RIGHTS-UNDER-UNCERTAINTY.md',
  'docs/architecture/DUAL-SURFACE-CAPABILITY-SURFACES.md',
  'docs/architecture/HUMAN-ENTITY-SOCIETAL-FABRIC.md',
  'docs/architecture/INTELLIGENCE-FABRIC-AND-COMPUTE-QUALIFICATION.md',
  'docs/architecture/MIRROR-INSTITUTIONS-AND-INFORMATION-METABOLISM.md',
  'docs/architecture/PERSISTENT-ORIENTATION-AND-TRIGGERED-COGNITION.md',
  'docs/architecture/PUBLIC-CORE-PRIVATE-ENTITY-OVERLAYS.md',
  'docs/architecture/TRUST-LOYALTY-AND-VULNERABLE-USER-SAFEGUARDS.md',
  ...
  'docs/architecture/contracts/agency-provenance.v0.schema.json',
  ...
  'docs/architecture/contracts/dormant-obligation.v0.schema.json',
  'docs/architecture/contracts/entity-foundation.v0.schema.json',
  'docs/architecture/contracts/entity-layer-stack.v0.schema.json',
  'docs/architecture/contracts/entity-layer.v0.schema.json',
  'docs/architecture/contracts/entity-lineage-event.v0.schema.json',
  'docs/architecture/contracts/human-sovereign-baseline.v0.schema.json',
  ...
  'docs/architecture/contracts/relational-deliberation.v0.schema.json',
  ...
  'docs/rebuild/HUMAN-ENTITY-SOCIETAL-CAPABILITY-MAP.md',
  ...
  'docs/security/BLANK-EGG-LAYER-AND-OVERLAY-THREAT-MODEL.md',
  ...
  'docs/superpowers/specs/2026-08-31-dual-surface-capability-completeness-design.md',
  'docs/superpowers/specs/2026-08-31-entity-agency-provenance-human-baseline-design.md',
  'docs/superpowers/specs/2026-08-31-personal-entity-resource-governance-design.md',
  'docs/superpowers/specs/2026-08-31-selective-interposition-native-reference-agent-design.md',
  'docs/superpowers/specs/2026-09-01-blank-egg-open-entity-foundation-design.md',
  ...
  'docs/superpowers/plans/2026-09-01-blank-egg-open-entity-foundation.md',
  'docs/superpowers/plans/2026-09-01-human-entity-societal-fabric-foundation.md',
