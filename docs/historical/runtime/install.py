...
def main():
    ...
    if launch_mode in ["launch-network", "launch-testnet"] and not auto_install:
        ...
        if not is_bootstrapped:
            ...
            print("By proceeding, you will receive an NFT and platform balance")
            print("compensation with a minimum target interest goal, as well")
            print("as other potential rewards and benefits within the network.")
            print("----------------------------------------------------------")
            print("==========================================================")
