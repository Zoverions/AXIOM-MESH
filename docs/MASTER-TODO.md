...
- [ ] **M13.7** Complete EDUCATION-CAPSULE implementation: Validate and evolve `schemas/education_tome.capnp` and implement production-grade multi-agent persona runtimes (childhood psychologist, guidance counselor, subject expert) (owner: sandbox+ai). — schema file exists; pending persona hardening and policy-backed runtime behavior
