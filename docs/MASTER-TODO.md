...
| VERIFY-001 | In progress | AXIOM Verify | Independent local/static signature/digest/continuity/scope/non-claim verification; experimental offline scaffold under packages/axiom-verify/ (receipt fixture PASS/FAIL, unknown-schema fail-closed, integrity-vs-truth report). Continuity/export checks deferred. Not a released product. |
