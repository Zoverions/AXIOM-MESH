...
| REP-005 | Complete | Exact source setup/dependency verification | Node 22.23.2+ shared-host/source compatibility or protected Node 24.14.0+; compatibility CI 22.23.2; protected CI/.node-version 24.18.0; production image 24.19.0; Node 22 bundled npm 10.9.8+ or npm 11.x; two zero-dependency locks; lifecycle scripts disabled; unchanged-lock proof |
