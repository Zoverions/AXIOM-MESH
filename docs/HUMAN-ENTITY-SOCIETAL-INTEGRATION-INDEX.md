...
- [`architecture/HUMAN-ENTITY-SOCIETAL-FABRIC.md`](architecture/HUMAN-ENTITY-SOCIETAL-FABRIC.md) — integrated layer model and constitutional invariants.
- [`architecture/PERSISTENT-ORIENTATION-AND-TRIGGERED-COGNITION.md`](architecture/PERSISTENT-ORIENTATION-AND-TRIGGERED-COGNITION.md) — long-duration intentionality without continuous inference.
- [`architecture/INTELLIGENCE-FABRIC-AND-COMPUTE-QUALIFICATION.md`](architecture/INTELLIGENCE-FABRIC-AND-COMPUTE-QUALIFICATION.md) — host/model qualification, native intelligence endpoints, routing, costs, narrow specialists, and future frontier entitlements.
- [`architecture/DUAL-SURFACE-CAPABILITY-SURFACES.md`](architecture/DUAL-SURFACE-CAPABILITY-SURFACES.md) — human-facing and agent-facing completeness rule and stable capability naming.
- [`architecture/DIGITAL-ENTITY-STATUS-AND-RIGHTS-UNDER-UNCERTAINTY.md`](architecture/DIGITAL-ENTITY-STATUS-AND-RIGHTS-UNDER-UNCERTAINTY.md) — cognitive privacy, status review, contestability, and precaution without a consciousness score.
- [`architecture/TRUST-LOYALTY-AND-VULNERABLE-USER-SAFEGUARDS.md`](architecture/TRUST-LOYALTY-AND-VULNERABLE-USER-SAFEGUARDS.md) — manipulation/dependency threat classes, vulnerable-user protections, and anti-self-reinforcement.
- [`architecture/MIRROR-INSTITUTIONS-AND-INFORMATION-METABOLISM.md`](architecture/MIRROR-INSTITUTIONS-AND-INFORMATION-METABOLISM.md) — parallel deliberation, institutional learning, claim circulation, attention, contribution, and anti-flood semantics.

## Existing architecture to retain and compose

These new documents extend rather than replace:

- [`architecture/RUNTIME-AND-CONNECTOR-FABRIC.md`](architecture/RUNTIME-AND-CONNECTOR-FABRIC.md)
- [`architecture/PERSONAL-COMPUTE-FABRIC-AND-LOCAL-TRUST.md`](architecture/PERSONAL-COMPUTE-FABRIC-AND-LOCAL-TRUST.md)
- [`architecture/SOVEREIGN-VAULTS-AND-CONTEXT-BROKER.md`](architecture/SOVEREIGN-VAULTS-AND-CONTEXT-BROKER.md)
- [`architecture/VAULT-LEASE-AND-CONTEXT-REQUEST.md`](architecture/VAULT-LEASE-AND-CONTEXT-REQUEST.md)
...
- [`MASTER-TODO-HUMAN-ENTITY-SOCIETAL-FABRIC.md`](MASTER-TODO-HUMAN-ENTITY-SOCIETAL-FABRIC.md) — P0/P1/P2 execution queue and acceptance evidence.
- [`rebuild/HUMAN-ENTITY-SOCIETAL-CAPABILITY-MAP.md`](rebuild/HUMAN-ENTITY-SOCIETAL-CAPABILITY-MAP.md) — human/machine surface traceability and honest architecture states.
- [`superpowers/plans/2026-09-01-human-entity-societal-fabric-foundation.md`](superpowers/plans/2026-09-01-human-entity-societal-fabric-foundation.md) — TDD implementation plan for the first inert contract/observer/proof slice.
...
5. Capability Surface Registry v0;
6. read-only host + intelligence inventory;
7. compute/model qualification + rule-based routing;
8. sterile Genesis Boot runtime-swap / counterpart-disabled / abundance-invariance proof;
9. only then update lifecycle/status documentation based on executable evidence.
