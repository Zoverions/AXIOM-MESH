...
- Versioned Gateway client contract (33 authenticated routes; relative-only application targets; no direct Grid/Hypervisor/Sandbox target from the browser app).
