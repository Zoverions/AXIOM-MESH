...
Refresh pin hash + SBOM/threat review before any adapter implementation merges. Selection becomes final only after Adapter v1 parity evidence for the read-only slice.
