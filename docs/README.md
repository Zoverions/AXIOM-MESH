...
## Execution Program
- **Canonical task board (agent-actionable):** `docs/TASK-BOARD.md`
...
- **Agent doc update policy:** `docs/AGENT-DOC-UPDATE-POLICY.md`
...
2. Strategy docs may coexist, but implementation task execution is governed by:
   - `docs/TASK-BOARD.md`
...
- task status updates in `docs/TASK-BOARD.md` when applicable.
...
## 5) Archived/Non-Canonical Docs

Draft launch communications and historical messaging are stored under `docs/archive/` and are non-canonical for implementation decisions.
