...
| How does Axiom Science represent causal inquiry and experiment proposals without inheriting authority? | [`superpowers/specs/2026-09-17-axiom-science-v0-design.md`](superpowers/specs/2026-09-17-axiom-science-v0-design.md) and [`superpowers/plans/2026-09-17-axiom-science-v0.md`](superpowers/plans/2026-09-17-axiom-science-v0.md) | Science Study and Experiment Proposal contracts over Research Capsule, Epistemic Fabric, and the Research Composition Graph | Experiment execution, autonomous truth, live model routing, instrument control, publication authority, or runtime capability |
...
causal-inquiry work, continue through **Axiom Science v0 design -> S0 plan ->
Science Study / Experiment Proposal**, while reusing Research Composition Graph
v0 rather than creating a second research graph. Use **migration
...
- Axiom Science Study and Experiment Proposal objects are science-domain
  organization/proposal artifacts only: causal reasoning may propose tests, but
  these objects create no experiment, publication, spending, disclosure,
  instrument, or runtime authority and do not establish scientific truth;
...
- [Axiom Science v0 design](superpowers/specs/2026-09-17-axiom-science-v0-design.md)
  — thin science-domain semantics and a theory/causal-inquiry direction over
  Research Capsule, Epistemic Fabric, and Research Composition Graph v0.
- [Axiom Science v0 S0 implementation plan](superpowers/plans/2026-09-17-axiom-science-v0.md)
  — inert Science Study and Experiment Proposal contracts, deterministic
  validation, synthetic composition fixtures, and authority-boundary tests.
...
Axiom Science S0 adds only inert Science Study and Experiment Proposal contracts
plus deterministic validation/composition tests. Its causal-inquiry direction
may generate hypotheses and discriminating tests, but it adds no experiment
execution, provider routing, instrument control, publication surface, capability,
or scientific-truth primitive.
...
Intelligence A/B, Research Capsule v0, Research Composition Graph v0, and Axiom
Science S0 work must be explicitly admitted to that allowlist, and their
zero-authority/non-truth invariants must remain
