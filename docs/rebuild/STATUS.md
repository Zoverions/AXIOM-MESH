...
Registry digest: `8223c0c40f8aa9671b85ade6a1fa06712d583d2c68e4073c0371639fd4bf1c6e`
...
| `ui.gateway-client` | operations | **implemented** | A versioned same-origin Gateway client contract covers all 30 authenticated routes with exact route parity, bounded responses and timeouts, AbortSignal cancellation, stable idempotent intent results, explicit errors, and no direct internal-service access. |
