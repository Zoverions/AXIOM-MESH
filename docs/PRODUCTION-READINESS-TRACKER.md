...
| Machine response-lifetime recheck (#1840) | Validation candidate; not merge-ready | Code/test candidate `621fb05b69e493b78048b19796b6788aea0872f7`; declared expiry at application-response inspection; exploratory source-slice evidence only | Verify the final exact head on Node 24.18.0, full check/release/documentation gates, applicable platform CI, and authorized review; do not inherit parent CI or claim atomic disclosure |
