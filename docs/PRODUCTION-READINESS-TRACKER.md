...
| Container network boundary | Pass for candidate topology | Single internal Compose network; startup rejects IPv4/IPv6 default routes; protected CI proves host-loopback ingress and blocked public TCP egress in signed evidence | Repeat on the pilot platform and independently review host/daemon policy |
